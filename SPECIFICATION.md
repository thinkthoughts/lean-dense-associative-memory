...
During the talk, prioritize:

1. **Energy** — explicit DAM energy function.
2. **Update** — state or dynamics equation.
3. **Fixed point** — attractor / stationary condition.
4. **Convergence** — energy descent or convergence result and its assumptions.
5. **Capacity** — storage-capacity statement and hypotheses.

If one appears, capture the equation **plus its assumptions and surrounding context**.

The extended acquisition-target list below remains available for Energy Transformer, PDE, and analog-hardware relations.

### Extended acquisition targets
